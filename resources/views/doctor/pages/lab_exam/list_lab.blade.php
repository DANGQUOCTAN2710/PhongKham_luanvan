...
<main class="col-md-10 ms-sm-auto px-md-4">
    <h2 class="my-3 text-center text-primary">Danh Sách Bệnh Nhân Chờ Thực Hiện Cận Lâm Sàng</h2>
                ...
                <tr>
                    ...
                    <td class="text-center align-middle">
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('lab.show', $key->id) }}" class="btn btn-success btn-sm d-flex align-items-center justify-content-center" style="width: 40px; height: 40px; padding: 0;">
